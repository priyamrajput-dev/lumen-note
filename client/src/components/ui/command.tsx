...
function CommandDialog({
  ...
  description = "Search workspaces, jump to research tools, or toggle preferences...",
  children,
  className,
  ...
  return (
    ...
    >
      ...
      <CommandPrimitive.Input
        ...
        className={cn(
          "w-full bg-transparent text-sm text-foreground placeholder:text-muted outline-hidden disabled:cursor-not-allowed disabled:opacity-50",
          className
        )}
        {...props}
      />
...
function CommandList({
  ...
  return (
    <CommandPrimitive.List
      ...
      className={cn(
        "max-h-80 scroll-py-2 overflow-x-hidden overflow-y-auto p-2 outline-none",
        className
      )}
      {...props}
    />
...
function CommandEmpty({
  ...
  return (
    <CommandPrimitive.Empty
      ...
      className={cn("py-8 text-center text-xs text-muted font-mono", className)}
      {...props}
    />
  )
}
...
function CommandGroup({
  ...
  return (
    <CommandPrimitive.Group
      ...
      className={cn(
        "overflow-hidden p-1 text-foreground [&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:py-1.5 [&_[cmdk-group-heading]]:text-[10px] [&_[cmdk-group-heading]]:font-mono [&_[cmdk-group-heading]]:uppercase [&_[cmdk-group-heading]]:tracking-wider [&_[cmdk-group-heading]]:text-muted",
        className
      )}
      {...props}
    />
